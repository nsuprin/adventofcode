...
INPUT;
  ...
  public function setDirection($sDirection, $iValue) {
      if (in_array($sDirection, $this->aDirection)) {
          $iDirection = array_search($sDirection, $this->aDirection);
          switch ($this->aDirection[$iDirection]) {
              case 'N':
                  $this->iNorth += $iValue;
                  break;
              case 'S' :
              ...
              case 'W' :
                  ...
                  break;
              default:
                  throw new Exception('soucis de direction coco');
          }
      } else {
          switch ($sDirection) {
              case 'L':
